...
export function Experience() {
  ...
  const jump = useCallback((progress: number) => {
    ...
    window.scrollTo({ top: element.offsetTop + Math.max(0, distance) * progress, behavior: reduce ? 'instant' : 'smooth' })
  }, [reduce])
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      const timeline = gsap.timeline({
        scrollTrigger: { trigger: element, start: 'top top', end: 'bottom bottom', scrub: choreography.scrub, invalidateOnRefresh: true },
        onUpdate: updateAct,
      })
  ...
  return <>
    <a className="skip-link" href="#our-story">Skip the cake animation</a>
    <main id="top">
        ...
        <div className="stage">
          ...
          <div className="copy-track">
            <div className="act-copy intro-copy">
              ...
              <div className="actions"><a className="button" href={links.product}>Taste the plot twist <ArrowUpRight size={20} aria-hidden="true" /></a><a href="#cake" className="text-link" onClick={meet}>Meet the cake <ArrowDown size={17} aria-hidden="true" /></a></div>
            </div>
            ...
            <div className="act-copy final-copy" id="cake" aria-hidden={!isStatic} inert={!isStatic}>
              ...
              <div className="actions"><a className="button" href={links.product}>Taste the plot twist <ArrowUpRight size={20} aria-hidden="true" /></a></div>
